...
def clone(commands, root_dir):
    ...
    yield from run_commands(
        [(cmd, root_dir) for cmd in commands], max_processes=25, timeout=20)
...
if __name__ == '__main__':
    ...
    group.add_argument(
        '-c', '--config', help='Configuration file, see bb_clone_repos.json')
    parser.add_argument(
        '-b',
        '--branch',
