...
def walk_to():
    return [
        ('/root/dest_dir', ('.git', 'both'), ('dest_file', 'both')),
...
def test_add(
    ...
    # assert [
    #     call('root/dest_dir/source_file'),
    #     call('root/dest_dir/both'),
    #     call('root/dest_dir/both/source_file'),
    #     call('root/dest_dir/both/diff')
    # ] == mock_exists.mock_calls

    # assert [
    #     call('/root/source_dir/both', 'root/dest_dir/both'),
    ...
    # assert [
    #     call('Added from /root/source_dir/source_file '
    #          'to root/dest_dir/source_file'),
    #     call('Added from /root/source_dir/both/source_file '
    #          'to root/dest_dir/both/source_file'),
    #     call('Updated from /root/source_dir/both/diff '
    #          'to root/dest_dir/both/diff')
