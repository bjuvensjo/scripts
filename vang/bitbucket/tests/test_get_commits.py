...
# commit = {'id': 'ec16b1a4d9a3542c3b6bf8306b9d5b8c0b2740c9',
#      'displayId': 'ec16b1a4d9a',
#      'author': {'name': 'name', 'emailAddress': 'emailAddress'},
#      'authorTimestamp': 1612258047000,
#      'committer': {'name': 'name', 'emailAddress': 'emailAddress'},
#      'committerTimestamp': 1612258047000,
#      'message': 'msg',
#      'parents': [{'id': 'f28d245de66972351053c5f1501c3c875b94a0f4', 'displayId': 'f28d245de66'}]}
#
#
# @patch('vang.bitbucket.get_commits.call')
# def test_get_commit_page(mock_call):
#     mock_call.return_value =

# @patch('vang.bitbucket.get_branches.call')
# def test_get_branch_page(mock_call, fixtures):
#     mock_call.return_value = fixtures[0]
#     assert (
#                fixtures[0]['size'],
#                fixtures[0]['values'],
#                fixtures[0]['isLastPage'],
#                fixtures[0].get('nextPageStart', -1),
...
#
# @patch('vang.bitbucket.get_branches.call')
# def test_get_all_branches(mock_call, fixtures):
#     mock_call.side_effect = fixtures
#     assert (['project_key', 'repo_slug'], fixtures[0]['values'] +
#             fixtures[1]['values']) == get_all_branches(
