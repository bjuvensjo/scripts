...
from vang.nexus3.api import call as nexus3_call, create_request
...
@patch('vang.nexus3.api.urlopen', autospec=True)
@patch('vang.nexus3.api.create_request', autospec=True)
...
def test_create_request():
    assert create_request({
        ...
        'Content-Type': 'application/json'
    }, 'POST', '"request_data"', 'http://rest_url/uri')
