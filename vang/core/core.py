...
def pmap_ordered(f: Callable[[Any], Any], iterable: Iterable[Any], chunksize: int = 1, processes: int = 10) -> Iterable[Any]:
...
def pmap_unordered(f: Callable[[Any], Any], iterable: Iterable[Any], chunksize: int = 1, processes: int = 10) -> Iterable[Any]:
    with Pool(processes=processes) as pool:
